...
| SRC-0201 | A | AP1000-DCD-R19-GENERIC | AP1000 Design Certification Amendment Final Rule, Item 11 Reactor Coolant Pump Design | Federal Register 76 FR 82079-82103, 2011-12-30 | Confirms Revision-19 certification incorporates single-stage canned RCP, externally mounted heat exchanger and bimetallic flywheel design |
...
| SRC-0209 | A | VOGTLE-3/VOGTLE-4 | NRC Integrated Inspection Reports 05200025/2019001 and 05200026/2019001 | ADAMS ML19135A691, issued 2019-05-15 | Public Vogtle AP1000 SG and reactor-vessel fabrication evidence plus document-number trails; includes RV outline/general-assembly/nozzle/head/DVI/vent/latch/machining drawing identifiers and SG fabrication records |
| SRC-0210 | A | VOGTLE-4-CURRENT-PUBLIC | NRC construction inspection/material verification record for Vogtle Unit 4 reactor vessel | ADAMS ML16210A448 | Plant-specific as-built reactor-vessel drawing references, ASME N-1/N-2 data-report identifiers and certified-material-test-report traceability for shell/nozzles/transition ring/CRDM-nozzle/filler-metal items |
| SRC-0211 | A | VOGTLE-3/VOGTLE-4 | NRC inspection record with RCS/PXS/RNS/CVS P&ID and piping/support specification document lists | ADAMS ML23033A397 | Current generic P&ID revision trail and construction-specification identifiers for Class 1 piping, piping class sheets and pipe/tubing supports |
| SRC-0212 | A | VOGTLE-3/VOGTLE-4 | NRC construction inspection record with RNS suction/discharge and RCS construction documents | ADAMS ML16312A506 | RNS pump suction/discharge isometrics, RCS P&ID revision trail, fabrication/installation specifications and support/tubing-support document identifiers |
| SRC-0213 | A | VOGTLE-4-CURRENT-PUBLIC | NRC construction inspection record with surge-line and PRHR/ADS piping work packages | ADAMS ML20042E292; ML20315A455 | Surge-line spool isometrics/support drawing revisions, PRHR supply isometrics, ADS construction drawings, weld data sheets and welding-material records |
...
Site-specific systems and interfaces that are intentionally left to a COL holder by the generic DCD must be resolved from the selected plant-specific baseline rather than replaced by generic assumptions.
